...
export default function CalendarScreen() {
  ...
  const { studyData, sessions, currentStreak, bestStreak, weeklyActivity } =
    useMemo(() => {
      ...
      const { current, best } = calculateStreak(data);
      ...
      return {
        ...
        bestStreak: best,
        weeklyActivity: getWeeklyActivity(data),
      };
